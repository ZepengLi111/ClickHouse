...
timeSeriesMaxToGrid(start_timestamp, end_timestamp, grid_step, staleness)(timestamp, value)
    ...
    FunctionDocumentation::ReturnedValue returned_value_timeSeriesMaxToGrid = {"`max_over_time` values on the specified grid as an `Array(Nullable(Float64))`. The returned array contains one value for each time grid point. The value is NULL if there are no samples within the window for a particular grid point.", {}};
...
└─────────────────────────────────────────────────────────────────────────────────────────┘
    ...
    FunctionDocumentation::IntroducedIn introduced_in_timeSeriesMaxToGrid = {26, 8};
...
timeSeriesMinToGrid(start_timestamp, end_timestamp, grid_step, staleness)(timestamp, value)
    ...
    FunctionDocumentation::ReturnedValue returned_value_timeSeriesMinToGrid = {"`min_over_time` values on the specified grid as an `Array(Nullable(Float64))`. The returned array contains one value for each time grid point. The value is NULL if there are no samples within the window for a particular grid point.", {}};
...
└─────────────────────────────────────────────────────────────────────────────────────────┘
    ...
    FunctionDocumentation::IntroducedIn introduced_in_timeSeriesMinToGrid = {26, 8};
